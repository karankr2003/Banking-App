...
public class PaymentFragment extends Fragment {
    ...
    private void makePayment() {
        ...
        try {
            ...
            if (Double.parseDouble(edtPaymentAmount.getText().toString()) >= 100) {
                isNum = true;
            }
        } catch (Exception e) {
            e.printStackTrace();
        ...
        if (isNum) {
            ...
            Toast.makeText(getActivity(), "Please enter a valid amount, greater than 100", Toast.LENGTH_SHORT).show();
            edtPaymentAmount.getText().clear();
        }
    }
