...
public class DrawerActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    private void makeDeposit() {
        ...
        if (depositAmount < 500 && !isNum) {
            ...
            Toast.makeText(this, "Deposit of Rs. " + String.format(Locale.getDefault(), "%.2f",depositAmount) + " " + "made successfully", Toast.LENGTH_SHORT).show();
    ...
    public void displayHelpDialog() {
        ...
        builder.setTitle("Help")
                .setMessage("This Bank App Demo was made Rakshitha and Ranjana.This dialog will give the user help, depending on where they are in the app");
